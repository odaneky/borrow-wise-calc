    ...
    <div className="mb-8">
      ...
      <div className="relative">
        <div className="flex items-center bg-gray-50 border-2 border-gray-200 rounded-xl overflow-hidden transition-all duration-300 focus-within:border-blue-400 focus-within:shadow-lg focus-within:shadow-blue-100">
          {prefix && (
            <span className="px-4 py-4 bg-gray-200 text-gray-600 font-semibold text-sm">
              {prefix}
            </span>
          )}
          ...
          <input
            ...
            className="flex-1 px-4 py-4 bg-transparent border-none outline-none text-slate-800 text-base placeholder-gray-400"
