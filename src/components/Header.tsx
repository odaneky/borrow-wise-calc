  ...
  return (
    <header className={`px-8 py-5 transition-all duration-300 ${
      isLandingPage 
        ...
        : "bg-gradient-to-r from-slate-700 to-slate-600 text-header-foreground flex justify-between items-center flex-wrap gap-4"
    }`}>
      ...
      {/* Spacer div to balance the layout when not on landing page */}
      {!isLandingPage && <div className="w-[120px]"></div>}
    </header>
  );
};
